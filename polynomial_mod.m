...
%   example: 'a' = [0 1 1 0 1] represents the polynomial x^3 + x ^2 + 1.  
%   The function returns the remainder, r, of this polynomial division also
...
while length(a) >= length(b)
    ...
    % Remove zeros past the left most one in 'a' such that the MSB of 'a' 
    % is one. Note if the MSB is already a one, then 'a' remains unchanged. 
    a = a(first1:length(a));
