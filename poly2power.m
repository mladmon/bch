...
%to [0 0 0 0 0], poly2power returns -1 which coresponds to decimal value of
%0.
%   GF has n-Tuple Form elements, each of which are 5 bits wide.  Zeros
%   must be padded onto poly, if necessary, to make poly 5 bits wide so
%   that its dimensions match the elements of GF. 
